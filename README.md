...
All these analyses can be found in our "final_code" and should work right up, when all code is run, if this should not be the case, just run the code chunks individually. <br>
